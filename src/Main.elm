...
update msg model =
    case msg of
        ...
        RandomPrefecture score (prefecture :: remainingPrefectures) ->
            ( Playing (GameState { prefecture | status = Accent } remainingPrefectures [] score "") emptyTray, Cmd.none )

        RandomPrefecture state [] ->
            ( Finished state emptyTray, Cmd.none )

        CheckAnswer { currentPrefecture, remainingPrefectures, guessedPrefectures, score, guess } tray ->
            let
            ...
            in
            ( case remainingPrefectures of
                p :: ps ->
                    if answerWasCorrect then
                        Playing (GameState p ps ({ currentPrefecture | status = Correct } :: guessedPrefectures) updatedGameScore "") tray

                    else
                        Playing (GameState p ps ({ currentPrefecture | status = Failed } :: guessedPrefectures) updatedGameScore "") tray
...
fillColor : Prefecture -> Int -> List Prefecture -> Svg.Attribute msg
fillColor currentPrefecture id guessedPrefectures =
    if currentPrefecture.id == id then
    ...
    Html.div
        ...
        , Html.div [ Attr.class "flex-1 flex items-center justify-center p-4 md:p-8" ] <|
            case model of
                ...
                Playing ({ currentPrefecture, guessedPrefectures, score, guess } as gameState) tray ->
                    [ Html.div
                                            ...
                                            [ Svg.g
                                                ...
                                                [ Svg.g
                                                    ...
                                                    [ Svg.g
                                                        ...
                                                        , fillColor currentPrefecture 1 guessedPrefectures
                                                        ]
                                                        [ path
                                                ...
                                                , Svg.g
                                                    ...
                                                    [ Svg.g
                                                        [ SvgAttr.id "2"
                                                        , SvgAttr.name "aomori"
                                                        , fillColor currentPrefecture 2 guessedPrefectures
                                                        ]
                                                        [ path
                                                    ...
                                                    , Svg.g
                                                        [ SvgAttr.id "3"
                                                        , SvgAttr.name "iwate"
                                                        , fillColor currentPrefecture 3 guessedPrefectures
                                                        ]
                                                        [ path
                                                    ...
                                                    , Svg.g
                                                        [ SvgAttr.id "4"
                                                        , SvgAttr.name "miyagi"
                                                        , fillColor currentPrefecture 4 guessedPrefectures
                                                        ]
                                                        [ path
                                                    ...
                                                    , Svg.g
                                                        [ SvgAttr.id "5"
                                                        , SvgAttr.name "akita"
                                                        , fillColor currentPrefecture 5 guessedPrefectures
                                                        ]
                                                        [ path
                                                    ...
                                                    , Svg.g
                                                        ...
                                                        , fillColor currentPrefecture 6 guessedPrefectures
                                                        ]
                                                        [ path
                                                    ...
                                                    , Svg.g
                                                        ...
                                                        , fillColor currentPrefecture 7 guessedPrefectures
                                                        ]
                                                        [ path
                                                ...
                                                , Svg.g
                                                    ...
                                                    [ Svg.g
                                                        ...
                                                        , fillColor currentPrefecture 8 guessedPrefectures
                                                        ]
                                                        [ path
                                                    ...
                                                    , Svg.g
                                                        ...
                                                        , fillColor currentPrefecture 9 guessedPrefectures
                                                        ]
                                                        [ path
                                                    ...
                                                    , Svg.g
                                                        [ SvgAttr.id "10"
                                                        , SvgAttr.name "gunma"
                                                        , fillColor currentPrefecture 10 guessedPrefectures
                                                        ]
                                                        [ path
                                                    ...
                                                    , Svg.g
                                                        ...
                                                        , fillColor currentPrefecture 11 guessedPrefectures
                                                        ]
                                                        [ path
                                                    ...
                                                    , Svg.g
                                                        [ SvgAttr.id "12"
                                                        , SvgAttr.name "chiba"
                                                        , fillColor currentPrefecture 12 guessedPrefectures
                                                        ]
                                                        [ path
                                                    ...
                                                    , Svg.g
                                                        [ SvgAttr.id "13"
                                                        , SvgAttr.name "tokyo"
                                                        , fillColor currentPrefecture 13 guessedPrefectures
                                                        ]
                                                        [ path
                                                    ...
                                                    , Svg.g
                                                        ...
                                                        , fillColor currentPrefecture 14 guessedPrefectures
                                                        ]
                                                        [ path
                                                ...
                                                , Svg.g
                                                    ...
                                                    [ Svg.g
                                                        ...
                                                        , fillColor currentPrefecture 15 guessedPrefectures
                                                        ]
                                                        [ path
                                                    ...
                                                    , Svg.g
                                                        [ SvgAttr.id "16"
                                                        , SvgAttr.name "toyama"
                                                        , fillColor currentPrefecture 16 guessedPrefectures
                                                        ]
                                                        [ path
                                                    ...
                                                    , Svg.g
                                                        ...
                                                        , fillColor currentPrefecture 17 guessedPrefectures
                                                        ]
                                                        [ path
                                                    ...
                                                    , Svg.g
                                                        [ SvgAttr.id "18"
                                                        , SvgAttr.name "fukui"
                                                        , fillColor currentPrefecture 18 guessedPrefectures
                                                        ]
                                                        [ path
                                                ...
                                                , Svg.g
                                                    ...
                                                    [ Svg.g
                                                        ...
                                                        , fillColor currentPrefecture 19 guessedPrefectures
                                                        ]
                                                        [ path
                                                    ...
                                                    , Svg.g
                                                        [ SvgAttr.id "20"
                                                        , SvgAttr.name "nagano"
                                                        , fillColor currentPrefecture 20 guessedPrefectures
                                                        ]
                                                        [ path
                                                    ...
                                                    , Svg.g
                                                        [ SvgAttr.id "21"
                                                        , SvgAttr.name "gifu"
                                                        , fillColor currentPrefecture 21 guessedPrefectures
                                                        ]
                                                        [ path
                                                    ...
                                                    , Svg.g
                                                        ...
                                                        , fillColor currentPrefecture 22 guessedPrefectures
                                                        ]
                                                        [ path
                                                    ...
                                                    , Svg.g
                                                        [ SvgAttr.id "23"
                                                        , SvgAttr.name "aichi"
                                                        , fillColor currentPrefecture 23 guessedPrefectures
                                                        ]
                                                        [ path
                                                    ...
                                                    , Svg.g
                                                        [ SvgAttr.id "24"
                                                        , SvgAttr.name "mie"
                                                        , fillColor currentPrefecture 24 guessedPrefectures
                                                        ]
                                                        [ path
                                                ...
                                                , Svg.g
                                                    ...
                                                    [ Svg.g
                                                        [ SvgAttr.id "25"
                                                        , SvgAttr.name "shiga"
                                                        , fillColor currentPrefecture 25 guessedPrefectures
                                                        ]
                                                        [ path
                                                    ...
                                                    , Svg.g
                                                        [ SvgAttr.id "26"
                                                        , SvgAttr.name "kyoto"
                                                        , fillColor currentPrefecture 26 guessedPrefectures
                                                        ]
                                                        [ path
                                                    ...
                                                    , Svg.g
                                                        [ SvgAttr.id "27"
                                                        , SvgAttr.name "osaka"
                                                        , fillColor currentPrefecture 27 guessedPrefectures
                                                        ]
                                                        [ path
                                                    ...
                                                    , Svg.g
                                                        [ SvgAttr.id "28"
                                                        , SvgAttr.name "hyogo"
                                                        , fillColor currentPrefecture 28 guessedPrefectures
                                                        ]
                                                        [ path
                                                    ...
                                                    , Svg.g
                                                        [ SvgAttr.id "29"
                                                        , SvgAttr.name "nara"
                                                        , fillColor currentPrefecture 29 guessedPrefectures
                                                        ]
                                                        [ path
                                                    ...
                                                    , Svg.g
                                                        ...
                                                        , fillColor currentPrefecture 30 guessedPrefectures
                                                        ]
                                                        [ path
                                                ...
                                                , Svg.g
                                                    ...
                                                    [ Svg.g
                                                        ...
                                                        , fillColor currentPrefecture 31 guessedPrefectures
                                                        ]
                                                        [ path
                                                    ...
                                                    , Svg.g
                                                        ...
                                                        , fillColor currentPrefecture 32 guessedPrefectures
                                                        ]
                                                        [ path
                                                    ...
                                                    , Svg.g
                                                        ...
                                                        , fillColor currentPrefecture 33 guessedPrefectures
                                                        ]
                                                        [ path
                                                    ...
                                                    , Svg.g
                                                        ...
                                                        , fillColor currentPrefecture 34 guessedPrefectures
                                                        ]
                                                        [ path
                                                    ...
                                                    , Svg.g
                                                        ...
                                                        , fillColor currentPrefecture 35 guessedPrefectures
                                                        ]
                                                        [ path
                                                ...
                                                , Svg.g
                                                    ...
                                                    [ Svg.g
                                                        ...
                                                        , fillColor currentPrefecture 36 guessedPrefectures
                                                        ]
                                                        [ path
                                                    ...
                                                    , Svg.g
                                                        [ SvgAttr.id "37"
                                                        , SvgAttr.name "kagawa"
                                                        , fillColor currentPrefecture 37 guessedPrefectures
                                                        ]
                                                        [ path
                                                    ...
                                                    , Svg.g
                                                        [ SvgAttr.id "38"
                                                        , SvgAttr.name "ehime"
                                                        , fillColor currentPrefecture 38 guessedPrefectures
                                                        ]
                                                        [ path
                                                    ...
                                                    , Svg.g
                                                        [ SvgAttr.id "39"
                                                        , SvgAttr.name "kochi"
                                                        , fillColor currentPrefecture 39 guessedPrefectures
                                                        ]
                                                        [ path
                                                ...
                                                , Svg.g
                                                    ...
                                                    [ Svg.g
                                                        ...
                                                        , fillColor currentPrefecture 40 guessedPrefectures
                                                        ]
                                                        [ path
                                                    ...
                                                    , Svg.g
                                                        [ SvgAttr.id "41"
                                                        , SvgAttr.name "saga"
                                                        , fillColor currentPrefecture 41 guessedPrefectures
                                                        ]
                                                        [ path
                                                    ...
                                                    , Svg.g
                                                        ...
                                                        , fillColor currentPrefecture 42 guessedPrefectures
                                                        ]
                                                        [ path
                                                    ...
                                                    , Svg.g
                                                        ...
                                                        , fillColor currentPrefecture 43 guessedPrefectures
                                                        ]
                                                        [ path
                                                    ...
                                                    , Svg.g
                                                        [ SvgAttr.id "44"
                                                        , SvgAttr.name "oita"
                                                        , fillColor currentPrefecture 44 guessedPrefectures
                                                        ]
                                                        [ path
                                                    ...
                                                    , Svg.g
                                                        ...
                                                        , fillColor currentPrefecture 45 guessedPrefectures
                                                        ]
                                                        [ path
                                                    ...
                                                    , Svg.g
                                                        ...
                                                        , fillColor currentPrefecture 46 guessedPrefectures
                                                        ]
                                                        [ path
                                                    ...
                                                    , Svg.g
                                                        ...
                                                        , fillColor currentPrefecture 47 guessedPrefectures
                                                        ]
                                                        [ path
